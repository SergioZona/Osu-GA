...
""" This class was made for taking fast Screenshots using the py"""
class WindowCapture:
    ...
    def __init__(self, window_name=None):
        ...
        # get the window size
        # This three lines are not getting the correct size of screen in pixels.
    ...
    def get_screenshot(self):
        ...
        img = img[...,:3] # Improves the FPS but fails with PNG images.
